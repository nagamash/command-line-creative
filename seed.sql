...
values
  ('aaaaaaaa-0000-0000-0000-000000000001', 'authenticated', 'authenticated', 'alice@clc.test',
  ...
  ('aaaaaaaa-0000-0000-0000-000000000002', 'authenticated', 'authenticated', 'bob@clc.test',
   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy',
   now(), '{"username":"bwilde","bio":"Creative technologist. Building at the intersection of brand and code."}', now() - interval '25 days', now()),

  ('aaaaaaaa-0000-0000-0000-000000000003', 'authenticated', 'authenticated', 'caro@clc.test',
   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy',
   now(), '{"username":"caro_m","bio":"Motion + interaction. Previously Figma, now independent."}', now() - interval '20 days', now()),

  ('aaaaaaaa-0000-0000-0000-000000000004', 'authenticated', 'authenticated', 'julius@clc.test',
   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy',
   now(), '{"username":"julius_r","bio":"Frontend engineer who thinks in design systems."}', now() - interval '15 days', now()),

  ('aaaaaaaa-0000-0000-0000-000000000005', 'authenticated', 'authenticated', 'petra@clc.test',
   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy',
...
values
  ('aaaaaaaa-0000-0000-0000-000000000001', 'alice_type',  'Type designer. Obsessed with variable fonts and optical sizing.', now() - interval '30 days'),
  ('aaaaaaaa-0000-0000-0000-000000000002', 'bwilde',      'Creative technologist. Building at the intersection of brand and code.', now() - interval '25 days'),
  ('aaaaaaaa-0000-0000-0000-000000000003', 'caro_m',      'Motion + interaction. Previously Figma, now independent.', now() - interval '20 days'),
  ('aaaaaaaa-0000-0000-0000-000000000004', 'julius_r',    'Frontend engineer who thinks in design systems.', now() - interval '15 days'),
  ('aaaaaaaa-0000-0000-0000-000000000005', 'petra_k',     'Generative art and creative coding. p5.js, GLSL, anything that runs.', now() - interval '10 days')
on conflict (id) do nothing;
...
values
  ...
  ('t0000002-0000-0000-0000-000000000003',
  ...
  -- PROCESS
  ('t0000003-0000-0000-0000-000000000001',
  ...
  ('t0000004-0000-0000-0000-000000000002',
  ...
  ('t0000005-0000-0000-0000-000000000002',
...
values
  ...
  ('r0000001-0000-0000-0000-000000000001',
   't0000001-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000002',
  ...
  ('r0000001-0000-0000-0000-000000000002',
   't0000001-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000004',
  ...
  ('r0000001-0000-0000-0000-000000000003',
   't0000001-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000001',
  ...
  ('r0000001-0000-0000-0000-000000000004',
   't0000002-0000-0000-0000-000000000003', 'aaaaaaaa-0000-0000-0000-000000000002',
  ...
  ('r0000001-0000-0000-0000-000000000005',
   't0000002-0000-0000-0000-000000000003', 'aaaaaaaa-0000-0000-0000-000000000003',
  ...
  ('r0000001-0000-0000-0000-000000000006',
   't0000003-0000-0000-0000-000000000002', 'aaaaaaaa-0000-0000-0000-000000000003',
  ...
  ('r0000001-0000-0000-0000-000000000007',
   't0000003-0000-0000-0000-000000000002', 'aaaaaaaa-0000-0000-0000-000000000004',
  ...
  ('r0000001-0000-0000-0000-000000000008',
   't0000005-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000005',
  ...
  ('r0000001-0000-0000-0000-000000000009',
   't0000005-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000001',
